...
print('Experiment: LGG expression, Jitkrittum')

for label in ['H0','ATRX']:
    ...
    np.savetxt(os.path.join(OUT_DIR,f'mean_contrast_names_lgg_expr_{label}.txt'),mean_contrast_names)
    ...
    out_df_baseline.to_csv(os.path.join(OUT_DIR,f'lgg_expr_{label}.csv'),index=False)
