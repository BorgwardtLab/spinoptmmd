...
print('Experiment: Same faces, Jitkrittum')
...
np.savetxt(os.path.join(OUT_DIR,f'mean_contrast_image_same_faces.txt'),mean_contrast_image)
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,f'same_faces.csv'),index=False)
