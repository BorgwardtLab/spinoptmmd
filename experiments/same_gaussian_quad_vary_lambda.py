...
print('Experiment: Same gauss vary lambda, quadratic')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'same_gaussian_quad_vary_lambda_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'same_gaussian_quad_vary_lambda.csv'),index=False)