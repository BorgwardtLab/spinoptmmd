...
print('Experiment: Same gauss vary lambda, linear')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'same_gaussian_lin_vary_lambda_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'same_gaussian_lin_vary_lambda.csv'),index=False)