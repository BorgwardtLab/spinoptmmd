...
print('Experiment: Same gauss vary sample size, linear')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'same_gaussian_lin_vary_sample_size_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'same_gaussian_lin_vary_sample_size.csv'),index=False)