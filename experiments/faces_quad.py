...
print('Experiment: Faces, quadratic')
...
np.savetxt(os.path.join(OUT_DIR,f'mean_contrast_image_faces_quad_lam_{lam}.txt'),mean_contrast_image)
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,f'faces_quad_baseline_lam_{lam}.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,f'faces_quad_lam_{lam}.csv'),index=False)