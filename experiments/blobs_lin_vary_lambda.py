...
print('Experiment: Blobs vary lambda, linear')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'blobs_lin_vary_lambda_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'blobs_lin_vary_lambda.csv'),index=False)