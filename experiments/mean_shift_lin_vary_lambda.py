...
print('Experiment: Mean shift vary lambda, linear')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'mean_shift_lin_vary_lambda_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'mean_shift_lin_vary_lambda.csv'),index=False)