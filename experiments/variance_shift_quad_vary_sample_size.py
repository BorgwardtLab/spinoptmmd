...
print('Experiment: Variance shift vary sample size, quadratic')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'variance_shift_quad_vary_sample_size_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'variance_shift_quad_vary_sample_size.csv'),index=False)