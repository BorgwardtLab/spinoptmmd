...
print('Experiment: Variance shift vary d, quadratic')
...
out_df_baseline.to_csv(os.path.join(OUT_DIR,'variance_shift_quad_vary_d_baseline.csv'),index=False)
out_df.to_csv(os.path.join(OUT_DIR,'variance_shift_quad_vary_d.csv'),index=False)